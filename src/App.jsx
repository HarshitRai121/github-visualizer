...
import FileDiagram from './components/FileDiagram'; // Add this line
import './App.css';
...
function App() {
  ...
  {repoData && !loading && (
    <div className="bg-gray-800 rounded-lg p-6 flex items-center justify-center min-h-[500px]">
      <FileDiagram repoData={repoData} />
    </div>
  )}
</main>
